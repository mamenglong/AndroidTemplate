...
import com.mml.template.BuildConfig
import com.mml.base.log.LogUtil
import com.mml.template.manager.UserManager
import com.mml.template.net.api.HEADER
import com.mml.template.net.api.NetworkSignParamsFactory
import com.mml.template.net.cookie.CookieJarImpl
import com.mml.template.net.cookie.PersistentCookieStore
import com.mml.template.net.ssl.AlwaysTrustHostnameVerifier
  ...
  fun provideOkHttpClient(
    ...
    private fun getOkClient(): OkHttpClient {
        ...
        builder.addInterceptor { chain ->
            ...
            newRequestBuilder.header("channel", com.mml.base.DataReport.getChannel(App.application))

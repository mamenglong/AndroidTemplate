...
import com.maibaapp.sweetly.databinding.LayoutUserPrivacyBinding
 ...
 * Package: com.mml.basewheelsbykotlin
...
abstract class BaseActivity : AppCompatActivity(),
    ...
    override fun onStart() {
        ...
        if (isCanShowAgreeDialog && (MMKV.default()
            ...
            dialogBuilder.apply {
                setTitle("温馨提示")
                setMessage(ConstString.USER_PRIVACY_MESSAGE.format(getString(R.string.app_name)))

...
object ConstString {
    ...
    object AppKey {
        // 阿里云轻 API
        const val ALIYUN_API_HOST = "json.api.bind.maibaapp.net"
    ...
    object URL {
         ...
         * 使用引导
         */
        val USE_HELP: String = "http://findu.withapp.love/assets/html/android-setting-help.html"

        //技术支持:
        const val TECHNICAL_SUPPORT =
            "https://support.findu.ink/assets/html/withu/contact-us/index.html"

        //使用条款 用户协议
        const val TERMS_OF_USE =
            "https://support.findu.ink/assets/html/withu/doc/withu-agreement.html"

        //用户隐私协议
        const val USER_PRIVACY_AGREEMENT =
            "https://support.findu.ink/assets/html/withu/doc/withu-privacy.html"

        // 会员协议
        const val MEMBERSHIP_AGREEMENT =
            "https://support.findu.ink/assets/html/withu/doc/withu-membership-service.html"

        //自动续费协议
        const val AUTOMATIC_RENEWAL_AGREEMENT =
            "https://support.findu.ink/assets/html/withu/doc/withu-membership-subcribe-service.html"
